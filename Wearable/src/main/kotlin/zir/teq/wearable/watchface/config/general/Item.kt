...
abstract class Item(val code: Int, val prefId: Int, val nameId: Int,
    ...
    companion object {
        val MAIN_COMPONENTS = MainItem(1000, R.string.saved_theme, R.string.label_components, R.drawable.icon_components, ComponentActivity::class.java)
        val MAIN_COLORS = MainItem(2000, R.string.saved_palette, R.string.label_colors, R.drawable.icon_color, PaletteActivity::class.java)
        val MAIN_WAVE = MainItem(3000, R.string.saved_wave_props, R.string.label_wave_props, R.drawable.icon_wave, MainWaveActivity::class.java)
        ...
        val STYLE_STACK = StyleItem(4300, R.string.saved_style_stack, R.string.label_stack, R.drawable.icon_stack, StyleStackActivity::class.java)
