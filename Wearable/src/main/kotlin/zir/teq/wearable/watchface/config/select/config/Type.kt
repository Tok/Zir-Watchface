...
data class Type(val code: Int,
    ...
    companion object {
        ...
        val PALETTE = Type(3, R.string.saved_palette, null, R.string.label_palette, R.drawable.icon_color)
        val BACKGROUND = Type(4, R.string.saved_background, null, R.string.label_background, R.drawable.icon_background)
