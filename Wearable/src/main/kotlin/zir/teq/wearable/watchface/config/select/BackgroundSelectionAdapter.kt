...
class BackgroundSelectionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val viewHolder = BackgroundViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.list_item_background, parent, false)
        )
        return viewHolder
    }
    ...
    inner class BackgroundViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        override fun onClick(view: View) {
            ...
            Log.d(TAG, "Background: $background onClick() position: $position sharedPrefString: $mPrefString")
