...
data class Theme(val name: String, val iconId: Int, val isFastUpdate: Boolean,
    ...
    companion object {
        ...
        val DEFAULT = Theme("Default", R.drawable.theme_default, false, Setting(true, false), set(true), Setting(false, true), set(true), set(true), Outline.OFF.name, Growth.OFF.name)
