...
class WaveSpectrumAdapter(private val options: List<Spectrum>) : RecAdapter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecHolder {
        ...
        return PropsHolder(view, Spectrum.pref, names)
    }

    override fun onBindViewHolder(vh: RecHolder, position: Int) {
        (vh as PropsHolder).bindProps(options[position].name, Spectrum.iconId)
    }
}
