...
class StrokeConfigItem internal constructor(name: String,
                                            iconId: Int,
                                            pref: String,
                                            val activity: Class<StrokeSelectionActivity>) : ConfigItem(name, iconId, pref), ConfigData.ConfigItemType {
