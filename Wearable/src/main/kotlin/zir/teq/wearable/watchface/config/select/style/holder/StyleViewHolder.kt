...
import zir.teq.wearable.watchface.config.select.style.activity.StyleActivity


class StyleViewHolder(view: View) : RecSelectionViewHolder(view) {
    init {
        mButton = view.findViewById<View>(R.id.list_item_main) as Button
        view.setOnClickListener { super.handleClick(view, StyleActivity.EXTRA, StyleActivity.REQ) }
    }
}
